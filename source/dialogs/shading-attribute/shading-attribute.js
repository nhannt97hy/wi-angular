let initModal;
function shadingAttributeDialog (ModalService, wiApiService, callback, shadingOptions, currentTrack, wiLogplotCtrl){
    let thisModal = null;
...
exports.shadingAttributeDialog = shadingAttributeDialog;
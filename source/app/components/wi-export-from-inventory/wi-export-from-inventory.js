const componentName = 'wiExportFromInventory';
const moduleName = 'wi-export-from-inventory';
...
function Controller($scope, $timeout, $attrs, wiApiService, wiComponentService, wiOnlineInvService) {
    ...
    this.$onInit = function () {
        wiComponentService.putComponent('wiExportFromInventory', self);
...
app.component(componentName, {
    templateUrl: 'wi-export-from-inventory.html',

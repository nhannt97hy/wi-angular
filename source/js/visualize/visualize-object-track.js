...
ObjectTrack.prototype.getCurrentObject = function() {
...
ObjectTrack.prototype.addObject = function(config, $scope, wiApiService) {
    let self = this;
    ...
    object.init(this.plotContainer, $scope, wiApiService);

const moduleName = 'wi-resizable';
const directiveName = 'wiResizable';
  ...
  return {
    ...
    link: function(scope, element, attr) {
      ...
      var updateInfo = function(e) {
        info.width = false;
        info.height = false;
        if (axis === 'x') info.width = parseInt(element[0].style[scope.rFlex ? flexBasis : 'width']);
        else info.height = parseInt(element[0].style[scope.rFlex ? flexBasis : 'height']);
      ...
      dir.forEach(function(direction) {
        ...
        grabber.addEventListener(
          'mousedown',
          function(e) {
            var disabled = eval(scope.rDisabled) === true;
